...
namespace pbrt.Spectrums
{
    ...
    {
        // all values come from: https://github.com/mmp/pbrt-v3/blob/master/src/core/spectrum.cpp
        public static readonly float CIE_Y_integral = 106.856895f;
        public static readonly float[] CIE_X =
        {
            #region CIE_X values
        ...
        public static readonly float[] CIE_Y =
        {
            #region CIE_Y values
        ...
        public static readonly float[] CIE_Z =
        {
            #region CIE_Z values
        ...
        public static readonly float[] CIE_lambda =
        {
            #region CIE_Lambda values
        ...
        public static readonly  int nCIESamples = 471;
        public static SampledSpectrum X, Y, Z;

        static XyzUtils()
        {
            X = new SampledSpectrum(SampledSpectrum.NSpectralSamples);
            Y = new SampledSpectrum(SampledSpectrum.NSpectralSamples);
            Z = new SampledSpectrum(SampledSpectrum.NSpectralSamples);
            
            for (int i = 0; i < SampledSpectrum.NSpectralSamples; ++i) 
            {
                float wl0 = MathUtils.Lerp((float)i / SampledSpectrum.NSpectralSamples, SampledSpectrum.SampledLambdaStart, SampledSpectrum.SampledLambdaEnd);
                float wl1 = MathUtils.Lerp((float)(i + 1) / SampledSpectrum.NSpectralSamples, SampledSpectrum.SampledLambdaStart, SampledSpectrum.SampledLambdaEnd);
                X.C[i] = SampledSpectrum.AverageSpectrumSamples(CIE_lambda, CIE_X, nCIESamples, wl0, wl1);
                Y.C[i] = SampledSpectrum.AverageSpectrumSamples(CIE_lambda, CIE_Y, nCIESamples, wl0, wl1);
                Z.C[i] = SampledSpectrum.AverageSpectrumSamples(CIE_lambda, CIE_Z, nCIESamples, wl0, wl1);
            }
        }
    }
}
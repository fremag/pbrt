...
namespace pbrt.Core
{
    public class Bounds2I
    {
        ...
        public Bounds2I Union(Bounds2I bounds1, Bounds2I bounds2) {
        ...
        public Bounds2I Intersect( Bounds2I bounds1,  Bounds2I bounds2) {
        ...
        public bool Inside(Point2I p, Bounds2I b) {
            return (p.X >= b.PMin.X && p.X <= b.PMax.X &&
                    p.Y >= b.PMin.Y && p.Y <= b.PMax.Y );
        }
        public bool InsideExclusive(Point2I p, Bounds2I b) {
            return (p.X >= b.PMin.X && p.X < b.PMax.X &&
                    p.Y >= b.PMin.Y && p.Y < b.PMax.Y );
        }
        
        public Bounds2I Expand(Bounds2I b, int delta) {
        ...
        public Point2I Lerp(Point3F t) =>  new Point2I((int)Lerp(t.X, PMin.X, PMax.X), (int)Lerp(t.Y, PMin.Y, PMax.Y));

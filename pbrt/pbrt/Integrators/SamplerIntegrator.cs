...
namespace pbrt.Integrators
{
    public abstract class SamplerIntegrator : Integrator
    {
        ...
        protected ISampler Sampler { get; }
        ...
        public abstract Spectrum Li(RayDifferential ray, IScene scene, ISampler sampler, int depth = 0);
        ...
        public Spectrum SpecularReflect(RayDifferential ray, SurfaceInteraction isect, IScene scene, ISampler sampler, int depth)
        {
        ...
        public Spectrum SpecularTransmit(RayDifferential ray, SurfaceInteraction isect, IScene scene, ISampler sampler, int depth)
        {
            Vector3F wo = isect.Wo;
            Vector3F wi;
            float pdf;

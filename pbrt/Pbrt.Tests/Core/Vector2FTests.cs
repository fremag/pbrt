...
namespace Pbrt.Tests.Core
{
    ...
    {
        private readonly Vector2F v1 = new Vector2F(1, 2);
        private readonly Vector2F v2 = new Vector2F(4, 5);
        private readonly Vector2F v3 = new Vector2F(-1, 0);
